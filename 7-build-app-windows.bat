...
call reportgenerator "-title:Gymmanager Library Documentation Coverage Report (Windows)" "-reports:**/lcov_doxygen_lib_win.info" "-targetdir:docs/coverxygenlibwin" "-reporttypes:Html" "-filefilters:-*.md;-*.xml;-*[generated];-*build*" "-historydir:report_doc_lib_hist_win"
...
call reportgenerator "-title:Gymmanager Library Test Documentation Coverage Report (Windows)" "-reports:**/lcov_doxygen_test_win.info" "-targetdir:docs/coverxygentestwin" "-reporttypes:Html" "-filefilters:-*.md;-*.xml;-*[generated];-*build*" "-historydir:report_doc_test_hist_win"
...
echo Generate Test Coverage Data for Gymmanager
call OpenCppCoverage.exe --export_type=binary:gymmanager_tests_unit_win.cov --sources src\gymmanager\src --sources src\gymmanager\header --sources src\tests\gymmanager -- build_win\build\Debug\gymmanager_tests.exe

echo Generate Test Coverage Data for Gymmanager App and Combine Results
call OpenCppCoverage.exe --input_coverage=utility_tests_unit_win.cov --input_coverage=gymmanager_tests_unit_win.cov --export_type=cobertura:gymmanagerapp_unit_win_cobertura.xml --sources src\utility\src --sources src\utility\header --sources src\gymmanager\src --sources src\gymmanager\header --sources src\gymmanagerapp\src --sources src\gymmanagerapp\header --sources src\tests\utility --sources src\tests\gymmanager -- build_win\build\Debug\gymmanagerapp.exe

echo Generate Unit Test Coverage Report
call reportgenerator "-title:Gymmanager Library Unit Test Coverage Report (Windows)" "-targetdir:docs/coveragereportlibwin" "-reporttypes:Html" "-reports:**/gymmanagerapp_unit_win_cobertura.xml" "-sourcedirs:src/utility/src;src/utility/header;src/gymmanager/src;src/gymmanager/header;src/gymmanagerapp/src;src/gymmanagerapp/header;src/tests/utility;src/tests/gymmanager" "-filefilters:-*minkernel\*;-*gtest*;-*a\_work\*;-*gtest-*;-*gtest.cc;-*gtest.h;-*build*" "-historydir:report_test_hist_win"
call reportgenerator "-targetdir:assets/codecoveragelibwin" "-reporttypes:Badges" "-reports:**/gymmanagerapp_unit_win_cobertura.xml" "-sourcedirs:src/utility/src;src/utility/header;src/gymmanager/src;src/gymmanager/header;src/gymmanagerapp/src;src/gymmanagerapp/header;src/tests/utility;src/tests/gymmanager" "-filefilters:-*minkernel\*;-*gtest*;-*a\_work\*;-*gtest-*;-*gtest.cc;-*gtest.h;-*build*"
...
call robocopy src\gymmanager\header "build_win\build\Release" /E
call robocopy src\gymmanagerapp\header "build_win\build\Release" /E
...
call robocopy src\gymmanager\header "build_win\build\Debug" /E
call robocopy src\gymmanagerapp\header "build_win\build\Debug" /E
